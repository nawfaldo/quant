#!/usr/bin/env python3
"""Batch runner to fetch and import daily candle data for a CSV list of stocks,
year by year.

A thin driver: every write is done by ``yfinance_fetch&import_timeframe.py``,
which this runs once per stock. Nothing here touches the store directly.
"""
