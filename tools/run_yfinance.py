...
def main():
    ...
    print("==================================================")
    print("Starting Yahoo Finance fetch & import...")
    print("==================================================")
    print()

    # Step 1: NQ (Intraday)
    print("--- 1/2 Fetching & Importing NQ (latest completed minute) ---")
    cmd_nq = [python_exe, 'yfinance_fetch&import.py', '--symbol', 'NQ=F', '--table-prefix', 'nq', '--timezone', 'America/New_York', '--latest-minute']
    ...
    # Step 2: VIX (Daily)
    print("--- 2/2 Fetching & Importing VIX (Daily) ---")
    ...
    print("==================================================")
    print("Yahoo Finance fetch & import completed successfully!")
    print("==================================================")
    print()
    wait_for_keypress()
    close_terminal_window()
