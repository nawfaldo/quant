...
export default function EnvironmentPage() {
  // This controls Environment-page navigation only. March keeps a separate,
  // per-tab environment selection in its workspace, so it must not be able to
  // reopen this detail view after the user presses Back.
  const [selectedEnvId, setSelectedEnvId] = useState<number | null>(null)
  const handleSelectEnv = (env: Environment | null) => setSelectedEnvId(env?.id ?? null)
